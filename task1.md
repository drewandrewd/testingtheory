...
**Тест-кейс 16: Попытка SQL-инъекции через productId**

Предусловия:
- Пользователь авторизован и имеет действующий токен аутентификации

Шаги:
- В path-параметре productId указать SQL-инъекцию `1 OR 1=1`
- В параметре запроса authToken установить валидное значение
- Отправить GET-запрос на эндпоинт `/products/{productId}/status`
- Проверить статус ответа
...
**Тест-кейс 17: Попытка SQL-инъекции через query-параметры**
...
Шаги:
- В параметре запроса authToken установить валидное значение
- В параметре запроса owner указать SQL-инъекцию `1 OR 1=1`
- Отправить GET-запрос на эндпоинт `/products/{productId}/status`
- Проверить статус ответа
